...
public class Historial extends javax.swing.JInternalFrame {
    ...
    private void lstUsuariosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lstUsuariosMousePressed
        // TODO add your handling code here:
        if (evt.getClickCount() == 2) {
           Programaciones form=new Programaciones();
             frmMenuOrdenanzas.escritorio.add(form);
             form.toFront();
             form.setVisible(true);
             this.dispose();

        }
    }//GEN-LAST:event_lstUsuariosMousePressed
