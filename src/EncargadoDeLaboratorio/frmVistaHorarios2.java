 ...
 * @author CRUZ_2019
 */
public class frmVistaHorarios2 extends javax.swing.JFrame {
    ...
    private void lstregistrosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lstregistrosMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            cod = lstregistros.getValueAt(fila, 0).toString();
               ...
               frmcrearprograma.txthorarioprogra.setText(cod);
               this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVistaHorarios2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVistaHorarios2().setVisible(true);
            }
        });
    }
